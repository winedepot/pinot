...
public class FilterQuery implements org.apache.thrift.TBase<FilterQuery, FilterQuery._Fields>, java.io.Serializable, Cloneable, Comparable<FilterQuery> {
  ...
  private static final org.apache.thrift.protocol.TField SUB_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("subField", org.apache.thrift.protocol.TType.STRING, (short)6);
  ...
  private String subField; // optional
  ...
  private static final _Fields optionals[] = {_Fields.COLUMN,_Fields.OPERATOR,_Fields.SUB_FIELD};
  ...
  static {
    ...
    tmpMap.put(_Fields.NESTED_FILTER_QUERY_IDS, new org.apache.thrift.meta_data.FieldMetaData("nestedFilterQueryIds", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
    tmpMap.put(_Fields.SUB_FIELD, new org.apache.thrift.meta_data.FieldMetaData("subField", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public void unsetSubField() {
    this.subField = null;
  }

  /** Returns true if field subField is set (has been assigned a value) and false otherwise */
  public boolean isSetSubField() {
    return this.subField != null;
  }

  public void setSubFieldIsSet(boolean value) {
    if (!value) {
      this.subField = null;
    }
  }
  ...
  public boolean equals(FilterQuery that) {
    ...
    boolean this_present_subField = true && this.isSetSubField();
    boolean that_present_subField = true && that.isSetSubField();
    if (this_present_subField || that_present_subField) {
      if (!(this_present_subField && that_present_subField))
        return false;
      if (!this.subField.equals(that.subField))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_subField = true && (isSetSubField());
    list.add(present_subField);
    if (present_subField)
      list.add(subField);
  ...
  public int compareTo(FilterQuery other) {
    ...
    lastComparison = Boolean.valueOf(isSetSubField()).compareTo(other.isSetSubField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSubField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.subField, other.subField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class FilterQueryStandardScheme extends StandardScheme<FilterQuery> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, FilterQuery struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // SUB_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.subField = iprot.readString();
              struct.setSubFieldIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FilterQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.subField != null) {
        if (struct.isSetSubField()) {
          oprot.writeFieldBegin(SUB_FIELD_FIELD_DESC);
          oprot.writeString(struct.subField);
          oprot.writeFieldEnd();
        }
      }
